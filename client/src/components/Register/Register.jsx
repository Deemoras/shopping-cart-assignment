  ...
  return (
        <div>
            <div className='form-container'>
              <form className='form-content' onSubmit={(e) => props.onSubmitClick(e, props.userDetails)}>
                  ...
                  onChange={(event) =>
                    props.setUserDetails({ ...props.userDetails, firstName: event.target.value })
                  }/>
                  <TextField id="standard-basic" 
                  label="Last Name" 
                  variant="standard" 
                  ...
                  onChange={(event) => 
                    props.setUserDetails({ ...props.userDetails, lastName: event.target.value })
                  }/>
                  <TextField id="standard-basic" 
                  label="Email" 
                  variant="standard" 
                ...
                />
                  ...
                  onChange={(event) =>
                    props.setUserDetails({ ...props.userDetails, confirmPwd: event.target.value })
                  }/>
                  <p
                    style={{
                  ...
                  >
                    {props.validation.statusErrorMessage || props.validation.statusSuccessMessage}
                  </p>
                  <Button 
                  variant="contained" 
                  type="submit"
